...
| Method | Description |
|:-|:-|
| void AddOutline(string text) | Adds an element into the report outline (read the chapter "Interactive reports") and sets the current position to the added element. |
...
| void AddBookmark(string name) | Adds a bookmark (read the chapter "Interactive reports"). |
